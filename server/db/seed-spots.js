...
// A handful of spots use family-curated Pexels photos instead (see also
// CURATED_SPOT_IMAGES in db/store.js, which keeps an already-seeded install in sync).
const px = (id, w) => `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=${w || 900}`;

const seedSpots = [
  { category: 'place', day: 2, city: '방콕', name: '왕궁 & 왓프라깨우', note: '올드타운의 시작. 복장 규정을 지켜야 입장할 수 있습니다.', map: 'Grand Palace Bangkok', image: px(38791407), tint: 'bl-200' },
  { category: 'place', day: 2, city: '방콕', name: '왓아룬', note: '타티엔 선착장에서 크로스보트로 강을 건너 도착.', map: 'Wat Arun Bangkok', image: px(35981272), tint: 'bl-100' },
  ...
  { category: 'place', day: 2, city: '방콕', name: '카오산 로드', note: '배낭여행자 거리의 상징. 프리마켓과 길거리 음식, 야시장 분위기.', map: 'Khao San Road Bangkok', image: px(35979665), tint: 'sand' },
  ...
  { category: 'place', day: 5, city: '파타야', name: '진리의 성전', note: '못 하나 쓰지 않고 짓는 목조 성전. 오후 관람.', map: 'Sanctuary of Truth Pattaya', image: px(4037038), tint: 'bl-100' },
  { category: 'place', day: 8, city: '방콕', name: '아이콘시암', note: '쑥시암 푸드코트와 팁싸마이 팟타이가 있는 강변 몰.', map: 'ICONSIAM Bangkok', image: px(28560920), tint: 'bl-200' },

  { category: 'meal', day: 2, city: '방콕', name: '쿤댕 꾸어이짭 유안', note: '카오산 인근. 베트남식 롤 쌀국수 맛집.', map: 'Khun Daeng Kuay Jub Yuan Bangkok', image: px(30982066, 800), tint: 'bl-100' },
  { category: 'meal', day: 2, city: '방콕', name: '엠쿼티어 헬릭스 푸드코트', note: '다양한 로컬 음식을 한자리에서. 1인 150~300바트.', map: 'EmQuartier Helix Quartier Food Court Bangkok', image: px(36817184, 800), tint: 'sand' },
  { category: 'meal', day: 4, city: '파타야', name: '터미널21 파타야 푸드코트', note: '팟타이 50바트, 카오카무 60바트 등 가성비 좋은 로컬 음식.', map: 'Terminal 21 Pattaya', image: px(28381598, 800), tint: 'bl-200' },
  { category: 'meal', day: 5, city: '파타야', name: '뿌펜 파타야', note: '게커리로 유명한 시푸드 맛집. 1인 약 500~1,000바트.', map: 'Pupen Seafood Pattaya', image: px(31027042, 800), tint: 'bl-300' },
